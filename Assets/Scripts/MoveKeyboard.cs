...
public class MoveKeyboard : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        InputActions.Player.EntNieve.performed += ctx => EntNieve();
        InputActions.Player.EntBosque.performed += ctx => EntBosque();
        InputActions.Player.EntDesierto.performed += ctx => EntDesierto();
    }
